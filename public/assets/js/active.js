(function () {
    ...
    // :: Tooltip 
    var tooltipddin = [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]'))
    var tooltipList = tooltipddin.map(function (tooltip) {
        return new bootstrap.Tooltip(tooltip);
    });

    // :: Toast 
    var toastddin = [].slice.call(document.querySelectorAll('.toast'));
    var toastList = toastddin.map(function (toast) {
