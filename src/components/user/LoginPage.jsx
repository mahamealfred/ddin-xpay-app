   ...
   const accessDetails={
    ...
    'password':password
      ...
      if(response.responseCode==="200"){
        ...
        context.updateAgentInstantCommissionAccountId(response.instantCommissionAccountId);
        context.updateAgentDelayedCommissionAccountId(response.delayedCommissionAccountId);
      ...
      toast.update(id, {render: "Dear customer we are unable to process your request now. please Try again later.", type: "info", isLoading: false,closeButton: null});
        ...
        <div class="container">
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="text-content">
              <h4 class="text-white mb-0 "><b style={{color:'#202a4e'}}>The Best Agents Network</b></h4>
              <p class="text-white mb-0"><span class="px-1 fw-bold"></span></p>
            </div>
          </div>
        </div>
            <div class="col-10 col-lg-8">
              ...
              <h4 class="text-white mb-1">LOGIN</h4>
                <form >
                  <div class="form-group text-start mb-4"><span style={{fontSize:16}}>Username:</span>
                    <label for="username"><i class="fa-solid fa-user" style={{color:'#202a4e'}}></i></label>
                    <input class="form-control" id="username" type="text" style={{backgroundColor:'white',color:'#202a4e',fontSize:16}} required  onChange={(e) => setUsername(e.target.value)} />
                  </div>
                  <div class="form-group text-start mb-4"><span style={{fontSize:16}}>Password:</span>
                    <label for="password"><i class="fa-solid fa-key" style={{color:'#202a4e'}}></i></label>
                    <input class="form-control" id="password" type="password" style={{backgroundColor:'white',color:'#202a4e',fontSize:16}} required  onChange={(e) => setPassword(e.target.value)} />
                  </div>
                  <button class="btn btn-warning btn-lg w-100"  onClick={onSigninClick}>Log In</button>
              ...
              <div class="login-meta-data">
                <p class="mb-0">Do you have an account?<a class="mx-1" href="https://core.ddin.rw/core/do/doPublicCreateMember?groupId=5">Register Now</a></p>
              </div>
