...
<div class="header-area" id="headerArea">
      <div class="container h-100 d-flex align-items-center justify-content-between d-flex rtl-flex-d-row-r">
        <div class="logo-wrapper"><a href="#"><img src="assets/img/icons/fav-icon-ddn.PNG" alt="DDIN"/><b style={{color:'#f8882b',fontSize:30}}>X</b><b style={{color:'#202a4e',fontSize:30}}>pay</b></a></div>
    ...
    <div class="offcanvas offcanvas-start ddin-offcanvas-wrap" tabindex="-1" id="ddinOffcanvas" aria-labelledby="ddinOffcanvasLabel">
     ...
     <div class="offcanvas-body">
       ...
       <ul class="sidenav-nav ps-0">
         ...
         <li class="ddin-dropdown-menu"><a href="#"><i class="fa-solid fa-list"></i>DDIN Services</a>
           <ul>
