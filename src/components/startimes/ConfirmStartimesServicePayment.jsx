/**
 * *@gniyonge
 * Confirm Startimes Service Payment
...
export default function ConfirmStartimesServicePayment(props){
  ...
  return (
    ...
    >
      <DialogTitle id="alert-dialog-title" style={{color:"#ff9900",fontSize:14}}>
       <b>{"TV Subscription Prepayment Confirmation:"}</b> 
      </DialogTitle>
      <DialogContent>
        <DialogContentText id="alert-dialog-description" style={{color:"black",fontSize:12}}>
         ...
         <Stack sx={{ width: '100%', color: 'grey.500' }} spacing={2}>
          ...
          <span>-Subscriber:<b>{props.customerAccountNumber}</b></span><br/>
          ...
          <span style={{color:'red', fontSize:12}}> Please confirm <b>TV Subscription Pre-payment:</b></span>
          </p>
