        ...
        <DialogContentText id="alert-dialog-description" style={{color:"black",fontSize:12}}>
         ...
         <Stack sx={{ width: '100%', color: 'grey.500' }} spacing={2}>
          <p style={{color:'black', fontSize:12}}>
             <span>-Token Amount: <b>Rwf {props.txTokenData.amount}</b></span><br/>
             <span>-Token:<b style={{color:"green"}}>{props.txTokenData.spVendInfo.voucher}</b></span><br/>
             <span>-Service Provider Name:<b>{props.txTokenData.spVendInfo.spName}</b></span><br/>
             <span>-Date:<b>{props.txTokenData.spVendInfo.tstamp}</b></span><br/>
             <span>-Units:<b>{props.txTokenData.spVendInfo.units}</b></span>
