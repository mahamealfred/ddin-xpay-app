...
export default function NpoReceiptManager() {
              ...
              <div >
                  ...
                  <div className="pdf-header" style={{paddingRight:10}}>
                    <span className="company-logo">
                      <img src="assets/img/core-img/icon-ddn-72-w.png" alt="DDIN Company" /> NPO Client Order
                    </span>
                    <span className="invoice-number"><b>Order: #</b><b>{state?.transactionData?.id}</b></span>
                  </div>
    ...
    <td><span>Tax Mode:</span></td><td><span>Inclusive</span></td>
                 ...
                 <div className="pdf-header" style={{padding:10}}>
                    ...
                    <div style={{fontSize:20, textAlign:'right',justifyItems:'right'}}>
                      ...
                      <b> Total To Be Paid(Rwf):<span >{(((parseFloat(state?.transactionData?.amount)))*(-4))}</span></b>
