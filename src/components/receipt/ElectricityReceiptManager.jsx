...
<HeaderPage/>
        ...
        <br/>
          <div class="section-heading d-flex align-items-center justify-content-between dir-rtl">
                ...
                <h6><Link class="btn p-0" to="/electricity-token"><i class="ms-1 fa-solid fa-arrow-left-long"></i> Back</Link></h6>{/*<a class="btn p-0" href="#">More<i class="ms-1 fa-solid fa-arrow-right-long"></i></a>*/}
              </div>
              ...
              <div >
                  ...
                  <div className="pdf-header" style={{paddingRight:10}}>
                    <span className="company-logo">
                      <img src="assets/img/core-img/icon-ddn-72-w.png" alt="DDIN Company" /> Electricity Receipt
                    </span>
    ...
    <td colSpan={2}><span class="ms-1" style={{color:'red'}} ><Link onClick={(e)=>viewFdiTxInfo(e,state?.transactionData?.description)}>Check Token Data</Link></span></td>  
    ...
    <td><span>Tax Mode:</span></td><td><span>Inclusive</span></td>
                 ...
                 <div className="pdf-header" style={{padding:10}}>
                    ...
                    <div style={{fontSize:20, textAlign:'right',justifyItems:'right'}}>
                      ...
                      <b> Total (Rwf):<span >{((parseFloat(state?.transactionData?.amount)*(1.02)*(-1))).toFixed()}</span></b>
