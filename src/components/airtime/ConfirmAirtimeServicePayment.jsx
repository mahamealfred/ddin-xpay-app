/**
 * *@gniyonge
 * Confirm Airtime Service Payment
...
export default function ConfirmAirtimeServicePayment(props){
  ...
  return (
    ...
    >
      <DialogTitle id="alert-dialog-title" style={{color:"#ff9900",fontSize:14}}>
       <b>{"Airtime Prepayment Confirmation:"}</b> 
      </DialogTitle>
      <DialogContent>
        <DialogContentText id="alert-dialog-description" style={{color:"black",fontSize:12}}>
         ...
         <Stack sx={{ width: '100%', color: 'grey.500' }} spacing={2}>
          <p style={{color:'black', fontSize:12}}>
            ...
            <span>-Airtime Provider:<b>{props.pdtName}</b></span><br/>
            <span>-Request Id:<b>{props.trxId}</b></span><br/>
            <span>-Airtime Amount:<b>Rwf {props.amount}</b></span>
          ...
          <p>
            ...
            <span style={{color:'red', fontSize:12}}> Please confirm <b>Airtime Pre-payment:</b>
</span>
          </p>
