/**
 * *@gniyonge
 * Agent Float Commission Account Page View
...
export default function AgentFloatAccountPage() {
 ...
 //Agent floac Ac Id Prod=7
  ...
  //Agent Commission A/C Id Prod=8
   ...
   //context.agentFloatAccountId
        //context.agentInstantCommissionAccountId
        //context.agentDelayedCommissionAccountId
    const response=await viewAgentFloatAccountStatus(context.userKey,context.agentFloatAccountId);
      ...
      if(response.responseCode==="200"){
        ...
        //console.log("Agent Account Status:"+response.responseDescription);
    ...
    <div class="header-area" id="headerArea">
      <div class="container h-100 d-flex align-items-center justify-content-between d-flex rtl-flex-d-row-r">
        ...
        <div class="navbar-logo-container d-flex align-items-center">
          ...
          {/*<div class="cart-icon-wrap"><a href="#"><i class="fa-solid fa-bell lni-tada-effect"></i><span>2</span></a></div>*/}
      ...
      <div class="discount-coupon-card-blue p-4 p-lg-5 dir-rtl">
          <div class="d-flex align-items-center">
            ...
            <div class="text-content">
              <h4 class="text-white mb-1">Agent Float A/C</h4>
              <p class="text-white mb-0">Available Balance: <b style={{fontSize:20}}>{formattedBalance}</b><span class="px-1 fw-bold"></span><b style={{fontSize:20}}></b></p>
            </div>
          </div>
        </div>
...
/*  "id": "130",
            "date": "2023-04-16T09:40:37.000+0000",
            "formattedDate": "16/04/2023",
            "processDate": "2023-04-16T09:40:37.000+0000",
            "formattedProcessDate": "16/04/2023",
            "amount": "-18.000000",
            "formattedAmount": "-18,00 Rwf",
            "transactionType": "Pindo Bulk Sms Payment Commission(DDIN)",
            "agentAccount": null,
            "description": "Pindo Bulk Sms Payment Commission(DDIN)",
            "destinationAccountName": "DDIN Agent Commission A/C",
            "destinationAccountHolderName": null
*/
                  if(transaction.transactionType!=="Pindo Bulk Sms Payment Commission(DDIN)"){
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <div class="product-description">
                         ...
                         <a class="product-title d-block" href="#">{transaction.description}</a>
                          ...
                          <div class="product-rating"><i class="fa-solid fa-star"></i>TX:{transaction.id}<span class="ms-1" style={{color:'red'}}><b>{transaction.formattedAmount}|</b></span><Link  to="#" state={{transactionData:transaction,agentUsername:context.agentUsername}} ></Link></div>
                        </div>
                      </div>
                    </div>
                  </div>
